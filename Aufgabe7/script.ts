...
var Song : string [] = [Sounds[5], Sounds[4], Sounds [3], Sounds[4], Sounds[5],  Sounds[5], Sounds[5], Sounds[9], Sounds[4], Sounds[4], Sounds[4], Sounds[9], Sounds[5], Sounds[6], Sounds[6], Sounds[9], Sounds[5], Sounds[4], Sounds [3], Sounds[4], Sounds[5], Sounds[5], Sounds[5], Sounds[9], Sounds[4], Sounds[4], Sounds[5], Sounds[4], Sounds [3],Sounds[7] , Sounds[8]] //Vielen Dank für die Hilfe bei den ,,//
var index1 : number = 0;
var index2 : number = 0;
