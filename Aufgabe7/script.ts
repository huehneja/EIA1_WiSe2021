...
var Song : string [] = [Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[9],Sounds[5], Sounds[4], Sounds [3], Sounds[4], Sounds[5],  Sounds[5], Sounds[5], Sounds[9], Sounds[4], Sounds[4], Sounds[4], Sounds[9], Sounds[5], Sounds[6], Sounds[6], Sounds[9], Sounds[5], Sounds[4], Sounds [3], Sounds[4], Sounds[5], Sounds[5], Sounds[5], Sounds[9], Sounds[4], Sounds[4], Sounds[5], Sounds[4], Sounds [3],Sounds[7] , Sounds[8] ,Sounds[9],Sounds[9]] //Wahrscheinlich gibts da auch ne bessere Lösung als , , aber ist ja eh kein Teil der Aufgabe (Führt zu Error Codes in der Konsole)//
var index1 : number = 0;
var index2 : number = 0;
