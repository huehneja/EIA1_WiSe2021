...
var Song : string [] = [Sounds[5], Sounds[4], Sounds [3], Sounds[4], Sounds[5],  Sounds[5], Sounds[5], Sounds[5], Sounds[4], Sounds[4], Sounds[4], Sounds[4], Sounds[5], Sounds[6], Sounds[6], Sounds[6], Sounds[5], Sounds[4], Sounds [3], Sounds[4], Sounds[5], Sounds[5], Sounds[5], Sounds[5], Sounds[4], Sounds[4], Sounds[5], Sounds[4], Sounds [3], Sounds[7], Sounds[8]]
var index1 : number = 0;
var index2 : number = 0;
setInterval(function () { playSample([Beat[index1]]), index1++; if (index1 == Beat.length){index1 = 0}}, 300);
setInterval(function () { playSample([Song[index2]]), index2++; if (index2 == Song.length){clearInterval}}, 600)
}
