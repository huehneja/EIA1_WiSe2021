...
function playBeat() {
    ...
    var Song = [Sounds[5], Sounds[4], Sounds[3], Sounds[4], Sounds[5], Sounds[5], Sounds[5], Sounds[5], Sounds[4], Sounds[4], Sounds[4], Sounds[4], Sounds[5], Sounds[6], Sounds[6], Sounds[6], Sounds[5], Sounds[4], Sounds[3], Sounds[4], Sounds[5], Sounds[5], Sounds[5], Sounds[5], Sounds[4], Sounds[4], Sounds[5], Sounds[4], Sounds[3], Sounds[7], Sounds[8]];
    var index1 = 0;
    var index2 = 0;
